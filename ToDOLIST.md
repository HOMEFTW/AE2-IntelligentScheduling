...
- [ ] 实现 `GuiCraftConfirm` 上的 `智能合成` 按钮与自定义 packet 下单入口
- [ ] 实现运行态 `SmartCraftOrderManager`、`SmartCraftScheduler`、`SmartCraftRequesterBridge`
...
- [x] 完成纯规划模型、订单量级判定与三挡拆分规则实现，并跑通对应测试
